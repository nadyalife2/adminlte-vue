...
<template>
  <div id="themeCustomizer" class="offcanvas offcanvas-end" tabindex="-1" aria-labelledby="themeCustomizerLabel">
    <div class="offcanvas-header border-bottom">
      <h5 id="themeCustomizerLabel" class="offcanvas-title"><i class="bi bi-palette me-2" />Customize</h5>
      <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close" />
    </div>
    <div class="offcanvas-body">
      <h6 class="text-secondary text-uppercase small">Color mode</h6>
      ...
      <h6 class="text-secondary text-uppercase small">Sidebar</h6>
      <div class="btn-group w-100" role="group" aria-label="Sidebar theme">
        ...
        >
          <i class="bi bi-moon-stars me-1" />Dark
        </button>
        <button
          type="button"
          class="btn"
        ...
        >
          <i class="bi bi-sun me-1" />Light
        </button>
      </div>

      <p class="text-secondary small mt-4 mb-0">Your choices are saved and restored on your next visit.</p>
    </div>
  </div>
</template>
