<template>
  <LteAppContent
    title="Form Elements"
    :breadcrumbs="[{ label: 'Home', href: '#' }, { label: 'Forms', href: '#' }, { label: 'Elements' }]"
  >
    <div class="row g-4">
      <div class="col-12">
      ...
      <!-- Quick Example -->
      <div class="col-md-6">
        <LteCard class="mb-4" title="Quick Example" theme="primary" variant="outline">
          <form>
            <div class="mb-3">
      ...
      <!-- Input Group -->
      <div class="col-md-6">
        <LteCard class="mb-4" title="Input Group" theme="success" variant="outline">
          <div class="input-group mb-3">
      ...
      <!-- Checks & Radios -->
      <div class="col-md-6">
        <LteCard class="mb-4" title="Checks & Radios" theme="info" variant="outline">
      ...
      <!-- Select / Range / File -->
      <div class="col-md-6">
        <LteCard class="mb-4" title="Selects, Ranges & File" theme="warning" variant="outline">
          <div class="mb-3">
      ...
      <!-- Floating labels -->
      <div class="col-md-6">
        <LteCard class="mb-4" title="Floating Labels" theme="secondary" variant="outline">
      ...
      <!-- Disabled / Readonly -->
      <div class="col-md-6">
        <LteCard class="mb-4" title="Disabled & Readonly" theme="danger" variant="outline">
          <div class="mb-3">
