...
@colorlib/adminlte-vue supports `light`, `dark`, and `auto` color modes built on Bootstrap's `data-bs-theme`
...
prevent it, `@colorlib/adminlte-nuxt` injects a small **blocking inline `<head>` script** (keyed
