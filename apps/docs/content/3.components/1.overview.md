...
Cards, boxes, stats and nav-dropdown widgets. Import from [`adminlte-vue`](/components/widget).
...
Form controls, plain and enhanced. Import from [`adminlte-vue`](/components/form).
...
Interactive utilities. Import from [`adminlte-vue`](/components/tool).
