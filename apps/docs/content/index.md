...
**AdminLTE Vue** (the `@colorlib/adminlte-vue` package) is a faithful port of [AdminLTE 4](https://adminlte.io)
...
| Package | What it is |
| --- | --- |
| **`@colorlib/adminlte-vue`** | The framework-agnostic Vue 3 component library — works in any Vite / Vue 3 / Nuxt app. |
| **`@colorlib/adminlte-nuxt`** | A thin Nuxt module: auto-registers the components, auto-imports the composables, injects the CSS + an SSR-safe color-mode script. |

## Which one?

- Use **`@colorlib/adminlte-vue`** directly for full control in any Vue 3 / Vite app — you wire the router and CSS yourself.
- Add **`@colorlib/adminlte-nuxt`** in a Nuxt app to remove all the wiring boilerplate (auto-registration, auto-imports, CSS, the color-mode head script).
