...
<script setup lang="ts">
import { useColorMode } from '@colorlib/adminlte-vue'
...
<script setup lang="ts">
import { useCommandPalette } from '@colorlib/adminlte-vue'
