...
These composables hold **local, per-component state** — unlike the provided composables (`useSidebar`, `useColorMode`, …) they do not rely on the layout's `provide`/`inject` context and can be called from any component. Import them from `@colorlib/adminlte-vue` (or rely on auto-import in Nuxt).
...
import { useCardWidget } from '@colorlib/adminlte-vue'
...
<script setup lang="ts">
import { useFullscreen } from '@colorlib/adminlte-vue'
...
```vue [DirectChat.vue]
<script setup lang="ts">
import { useDirectChat } from '@colorlib/adminlte-vue'
...
<script setup lang="ts">
import { ref } from 'vue'
import { useSortable } from '@colorlib/adminlte-vue'
...
<script setup lang="ts">
import { ref } from 'vue'
import { treeviewTransition } from '@colorlib/adminlte-vue'
